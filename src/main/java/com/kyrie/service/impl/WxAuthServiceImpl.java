...
import com.kyrie.mapper.XcUserMapper;
import com.kyrie.mapper.XcUserRoleMapper;
import com.kyrie.model.dto.AuthParamsDto;
import com.kyrie.model.dto.XcUserExt;
import com.kyrie.model.po.XcUser;
import com.kyrie.model.po.XcUserRole;
import com.kyrie.service.AuthService;
...
/**
 * @auther: jijin
 * @date: 2023/10/2 19:28 周一
 * @project_name: MyWechatLoginOAuth2
 * @version: 1.0
 * @description TODO execute方法是统一认证接口， wxAuth是微信扫码接口
 */
...
public class WxAuthServiceImpl implements AuthService,WxAuthService {
    ...
    public XcUser wxAuth(String code) {
        //申请令牌地址返回ResponseEntity对象
        Map<String, String> access_token_map = getAccess_token(code);

        //从ResponseEntity对象中拿令牌
